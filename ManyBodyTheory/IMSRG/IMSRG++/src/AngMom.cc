...
/// \f$\Delta(abc)\f$ of Varshalovich book. eq 8.2.1  
 ...
 /// check triangular relation of three j's 
...
///  
///  \f$ \langle n l, N L; \Lambda | n_1 l_1 n_2 l_2;\Lambda\rangle \f$ ?
///  what is B ?   
///  One have to check the convention ! 
