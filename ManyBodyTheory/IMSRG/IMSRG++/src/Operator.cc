...
///
///  From operator One-body and Twobody
///            -> opNO.ZeroBody = sum_x (2jx+1)*n(x)*OneBody(x,x)_j
///               opNO.OneBody roughly OneBody(x,y)_j + TwoBody(x,h,y,h)_j... 
///               opNO.TwoBody = TwoBody(a,b,c,d)  
//*************************************************************
Operator Operator::DoNormalOrdering2()
{
   Operator opNO(*this); // inherit original operator thus, opNO is not empty 
