...
{
  cout << "entering ReadBareTBME_Navratil_from_stream" << endl; //test  
  ModelSpace * modelspace = Hbare.GetModelSpace();
...
//  int herm = Hbare.IsHermitian() ? 1 : -1 ;
  ...
  cout << "!!ReadBareTBME_Navratil_from_stream mark1" << endl; //test  
...
//  infile >> total_number_elements >> N1max >> N12max >> hw >> srg_lambda;
  cout << "!!ReadBareTBME_Navratil_from_stream mark2" << endl; //test  
  ...
  cout << "!!ReadBareTBME_Navratil_from_stream end" << endl; //test  
