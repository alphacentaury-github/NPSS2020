...
C       ==========================================================
C
C        DOUBLE PRECISION X,Y,GR,GI
C        WRITE(*,*)'  Please enter KF, x and y'
C        READ(*,*)KF,X,Y
C        WRITE(*,*)
C        IF (KF.EQ.1) THEN
C            WRITE(*,*)'       x         y           Re[â(z)]',
C     &                '           Im[â(z)]'
C        ELSE
C            WRITE(*,*)'       x         y          Re[lnâ(z)]',
C     &                '         Im[lnâ(z)]'
C        ENDIF
C        WRITE(*,*)'    ------------------------------------',
C     &            '---------------------'
C        CALL CGAMA(X,Y,KF,GR,GI)
C        WRITE(*,10)X,Y,GR,GI
C 10      FORMAT(1X,2F10.2,2D20.10)
C        END
C
C
