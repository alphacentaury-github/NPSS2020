...
C
      ...
      COMMON       /STEE / PACCQ,NFP,NPQ,IEXP
...
C***  COULFG HAS CALLS TO: DSQRT,DABS,DMOD,IDINT,DSIGN,DFLOAT,DMIN1
      ...
      DATA HALF,TM30,BIG,SMALL / 0.5D0, 1.0D-30, 1.0D+200, 1.0D-300/
...
C
      ...
      IF(DABS(DMOD(DELL,ONE)) .GT. ACC4) WRITE(30,2040)XLMAX,XLMIN,DELL
      LXTRA = IDINT(DELL)
